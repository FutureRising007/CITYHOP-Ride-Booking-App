...
class PushNotificationSystem
{
  ...
  Future initializeCloudMessaging(BuildContext context) async
  {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage? remoteMessage) {
      ...
      // display ride request information - user information who requested for a ride
    ...
    //3. Background
    // When the app is in the background and is open using Push Notification
    ...
    FirebaseDatabase.instance.ref().
      child("All Ride Requests")
        ...
        if(snapData.snapshot.value != null){
          ...
          audioPlayer.open(Audio("notification_sound/music_notification.mp3"));
          audioPlayer.play();
          ...
          Fluttertoast.showToast(msg: "This Ride Request has expired.");
        }
    });
  }
